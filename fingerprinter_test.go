...
import (
	...
	"github.com/percona/mongodb-fingerprint/internal/tutil"
	"github.com/percona/mongodb-fingerprint/proto"
...
func TestFingerprints(t *testing.T) {
	...
	dir := filepath.Join(vars.RootPath, "/testdata/profiles")
	dirExpect := filepath.Join(vars.RootPath, samples, "/fingerprints/")
